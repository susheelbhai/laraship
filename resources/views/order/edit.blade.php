            ...
            <div class="card-body">
                <form class="row g-3 needs-validation" action="{{ route('laraship.order.edit', 8658) }}" method="post">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control" name="order_date" id="order_date" value="{{ $data['order_date'] }}" min="2023-07-09" required>
                    </div>
                    <div class="col-md-6">
                        ...
                        <select name="pickup_location" id="pickup_location" class="form-control">
                            ...
                            @foreach ($locations as $i)
                                <option value="{{ $i->pickup_location }}" @if($i->id== $data['pickup_location_id']) selected @endif>{{ $i->pickup_location }}</option>
                            @endforeach
                        </select>
                    </div>
